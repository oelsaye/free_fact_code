...
class _RegisterState extends State<Register> {
  ...
  //Creates a firebase autherization variable
  final AuthService _auth = AuthService();
  //Creates a key for the Form Widget
  final _formKey = GlobalKey<FormState>();


  //Variables for the dropdown menu, and loading menu
  bool loading = false;
  ...
  Widget build(BuildContext context) {
    return loading ? Loading() : Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('Sign up to Free Fact'),
        centerTitle: true,
      ),
      body: Container(
